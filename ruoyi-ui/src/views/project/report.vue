<template>
    <div class="contain">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="recomednations" label="建议">
            </el-table-column>
        ...
        <!-- 弹框 -->
        <el-dialog title="新增报告" :visible.sync="dialogvisbel" width="80%">
                ...
                <div v-if="false">
                    ...
                    <div class="br">
                        <div class="dialogheader">
                            ...
                            <div style="padding: 10px;">新增报告</div>
                        </div>
                    </div>
...
export default {
    data() {
        return {
            ...
            dialogvisbel: false,
            tableData: [
                { name: '预期市场行情', summary: '目前市场xxxx', conclusion: '11', recomednations: '22', creatTime: '22-20-20 10-22', createBy: '张三', state: '完工' }
