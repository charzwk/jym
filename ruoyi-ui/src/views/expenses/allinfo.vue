    ...
    <div class="contain">
        ...
        <div class="header">
            ...
            <div class="serachModel">
                ...
                <div class="topinput">
                    <span style="display: inline-block;">项目:</span> <el-select v-model="form.info3" placeholder="请选择项目">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="time" label="时间区域">
            </el-table-column>
            <el-table-column prop="pthour" label="人工总工时">
            </el-table-column>
            <el-table-column prop="ptcost" label="人工总费用">
            </el-table-column>
            <el-table-column prop="devhour" label="设备总工时">
            </el-table-column>
            <el-table-column prop="devcost" label="设备总费用">
            </el-table-column>
            <el-table-column prop="mcost" label="材料总费用">
            </el-table-column>
            <el-table-column prop="precost" label="预算金额">
            </el-table-column>
            <el-table-column prop="acost" label="实际金额">
            </el-table-column>
...
export default {
    data() {
        return {
            ...
            dialogvisbel: false,
            tableData: [
              {code:'0006',name:'项目a',time:'2024-10~2024-12',pthour:'1560',ptcost:'156000',
              devhour:'240',devcost:'15000',mcost:'10000',precost:'1500',acost:'20000'},
              {code:'0016',name:'项目b',time:'2024-10~2024-12',pthour:'1560',ptcost:'156000',
              devhour:'240',devcost:'15000',mcost:'10000',precost:'1500',acost:'20000'},
