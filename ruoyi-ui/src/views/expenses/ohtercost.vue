<template>
    <div class="contain">
        ...
        <el-pagination style="margin: 20px 0 ;" background layout="prev, pager, next" :total="1000">
         ...
         <!-- 弹框 -->
         <el-dialog title="其他费用" :visible.sync="dialogvisbel" width="80%">
...
export default {
    data() {
        return {
            ...
            dialogvisbel: false,
            tableData: [
              {matters:'差旅费用',code:'00006',name:'项目a',cost:'1500',isZx:'是'},
              {matters:'技术服务费用',code:'00006',name:'项目b',cost:'1500',isZx:'否'}
