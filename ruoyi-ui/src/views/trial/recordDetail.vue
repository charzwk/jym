            ...
            <div class="left" v-if="false">
                ...
                <div class="oneModel">
                    <div class="newadd">
                        ...
                        <div class="addbtn del" style="font-size: 20px;" @click="dialogvisbel4 = true" v-if="false">调研
                        </div>
                    ...
                    <div class="oneinfo">
                        <div class="oneitem">时间：2024-20-12 12:00</div>
                        <div class="oneitem">单号：006523252</div>
                ...
                <el-form ref="form" :model="form" label-width="100px">
                    ...
                    <div>
                        ...
                        <el-form-item label="上传时间">
                            <el-date-picker v-model="form.info2" type="datetime" placeholder="请选择上传时间"
                                style="width: 400px;">
                            </el-date-picker>
                        </el-form-item>
...
export default {
    data() {
        return {
            ...
            projectPersons: [
                { id: 1, name: 'ceshi.pdf', person: '张三', time: '2024-10-11 12:00',remark:'无' },
                { id: 2, name: 'aaa.pdf', person: '张三2', time: '2024-10-11 12:00',remark:'无' },
                { id: 3, name: 'css.word', person: '张三3', time: '2024-10-11 12:00',remark:'无' },
            ],
            projectPersons2: [
