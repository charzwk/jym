<template>
    <div class="contain">
        <div class="box">
            ...
            <!-- 弹框 -->
            <el-dialog title="新增人员" :visible.sync="dialogvisbel" width="50%">
                <el-form ref="form" :model="form" label-width="100px">
                    <!-- 第一步 项目信息 -->
                    <div>
                        <el-form-item label="人员">
                            <el-select v-model="form2.info1" placeholder="请选择人员">
                                <el-option v-for="item in personlist" :label="item.name" :value="item.id">{{ item.name
                                    }}</el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="人员编码">
                            <el-input v-model="form2.cost" placeholder="人员编码" disabled="true"></el-input>
                        </el-form-item>
                        <el-form-item label="工时">
                            <el-input v-model.number="form2.cost" placeholder="请输入工时" ></el-input>
                        </el-form-item>
                    </div>
                    <el-form-item>
...
export default {
    data() {
        return {
            ...
            projectPersons: [
                { id: 1, name: '张三', code: '00001', manhour: '1' },
                { id: 2, name: '里斯',  code: '00011', manhour: '2' },
                { id: 3, name: '无望', code: '00002', manhour: '11' },
            ],
            projectPersons2: [
