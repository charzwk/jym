<template>
    <div class="contain">
        ...
        <!-- 弹框 -->
        <el-dialog title="新增试验工时" :visible.sync="dialogvisbel" width="50%">
            ...
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <div>
                    ...
                    <el-form-item label="工时">
                        <el-input v-model.number="form.info11" type="text"  placeholder="请输入工时(小时)"></el-input>
                       
                    </el-form-item>
                    <el-form-item label="负责人">
                        <el-select v-model="form.info3" placeholder="请选择负责人">
                            <el-option v-for="item in phaseslist" :label="item.name" :value="item.id"></el-option>
                        </el-select>
...
export default {
    data() {
        return {
            ...
            dialogvisbel: false,
            tableData: [
                { name: '试验测试11', manhour:'3',person:'张三',remark: 'xxxx' },
    ...
    methods: {
        ...
        toDetail(){
            this.$router.push('/trial/manhourDetail')
        }
    }
}
</script>
